...
def get_model_config(model_variant):
    ...
    elif model_variant == "mamba_1b_pure_long":
        model_config = {
            "d_model": 1280,
            "d_intermediate": 3072,
            "n_layer": 32,
    ...
    elif model_variant == "hc_llama_1b":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "ra_llama_1b":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_unrope32_32k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_unrope32_128k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_32k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_1b_128k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=1280,
            nheads=16,
    ...
    elif model_variant == "llama_3b_unrope32_32k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=2048,
            nheads=16,
    ...
    elif model_variant == "llama_3b_unrope32_128k":
        model_config = LLaMAConfig(
            src_vocab_size=128256,
            emb_dim=2048,
            nheads=16,
