...
def main(**kwargs):
    ...
    if rank == 0:
        ...
        print(f"\n--> HCLLaMA model has {total_params / 1e6} Million params, {cfg.hc_num_streams} streams\n")
    ...
    # Recompute RoPE freqs on CUDA post-FSDP to avoid torch.compile graph breaks
